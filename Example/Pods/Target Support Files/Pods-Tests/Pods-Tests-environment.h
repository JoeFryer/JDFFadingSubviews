...
// JDFFadingSubviews
#define COCOAPODS_POD_AVAILABLE_JDFFadingSubviews
#define COCOAPODS_VERSION_MAJOR_JDFFadingSubviews 0
#define COCOAPODS_VERSION_MINOR_JDFFadingSubviews 1
#define COCOAPODS_VERSION_PATCH_JDFFadingSubviews 0
